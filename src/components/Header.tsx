  ...
  return (
		<header>
			...
			<div className="flex items-center space-x-3 p-2 pl-6 bg-fast_blue-light text-white text-sm">
				...
				<p className="link">PDF</p>
				<p className="link hidden md:inline-flex">Buy Again</p>
				<p className="link hidden md:inline-flex">New emojis</p>
				<p className="link hidden lg:inline-flex">Top 10 lists</p>
				<p className="link hidden lg:inline-flex">fractal pack</p>
				<p className="link hidden lg:inline-flex">Work Supplies</p>
				<p className="link hidden lg:inline-flex">Design figma</p>
			</div>
		</header>
	);
};
